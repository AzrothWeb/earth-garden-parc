    ...
    <body>
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <img src="./assets/img/phrase_titre.png" alt="Phrase EARTH" title="Descritpion EARTH" id="earthWords">
                    ...
                    <ul class="navbar-nav mr-auto listLink">
                        <li class="nav-item dropdown">
                         ...
                         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="nav-link" target="_blank" href="../assets/pdf/earthgardenparc.pdf">En savoir plus sur le projet</a>
                        </div>
                        </li>
                        <li class="nav-item">
