<?php
	class Connexion {
		...
		/**
		 * Créer une connexion à l'aide ddu connecteur de base de donnée PDO
		 * @see PDO
		...
		private function connexion(){
			try
			{
				$bdd = new PDO('mysql:host=earthgr732.mysql.db;dbname=earthgr732','earthgr732','EARTHgp01170', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
